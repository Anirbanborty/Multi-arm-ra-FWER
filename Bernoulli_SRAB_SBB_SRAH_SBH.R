...
resultbonopt=foreach (i=1:iterations,.combine=rbind)%dopar%{  
  set.seed(i)
  x1=c(1,0,rbinom(5,1,mu1))  ######generating pilot observations from control, initial 1,0 added to get sample mean in (0,1) 
  x4=c(1,0,rbinom(5,1,mu4))  ###generating pilot observations from experimental treatment 3, initial 1,0 added to get sample mean in (0,1) 
  x2=c(1,0,rbinom(5,1,mu2))  ###generating pilot observations from experimental treatment 1, initial 1,0 added to get sample mean in (0,1) 
  x3=c(1,0,rbinom(5,1,mu3))  ###generating pilot observations from experimental treatment 2, initial 1,0 added to get sample mean in (0,1) 
